...
class CategoryListView(LoginRequiredMixin, ExportMixin, tables.SingleTableView):
    """
...
class CategorySearchListView(CategoryListView):
    """
    View class to search and display a filtered list of category.
    ...
    def get_queryset(self):
        result = super(CategorySearchListView, self).get_queryset()
